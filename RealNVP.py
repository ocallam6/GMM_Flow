...
from GMMTorch import TorchGaussMixture
...
class FlowGMM(nn.Module):
    ...
    def forward(self,x):
        ...
        #The final column is for any available labels, important for when inputting data.
        ...
        for i in range(self.layers):
            #paper recommends doing batch normalisation at each layer but its not good
        ...
        log_likelihood=gmm.log_prob(y,labels).mean()
